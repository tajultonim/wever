  ...
  return (
    <div className="flex w-full justify-center">
      <div className="max-w-6xl w-full flex justify-center">
        <div className="sm:grid flex flex-col gap-x-2 max-h-[100vh] h-[100%] w-full grid-cols-12  px-4 ">
          <header className=" h-fit py-7 pt-8 sm:py-3 sm:bg-[#F7EEE5] z-50 sm:sticky top-0 col-span-12">
            <Header />
          </header>
